"""
Django settings for wdvn_42060 project.
...
WSGI_APPLICATION = 'wdvn_42060.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wdvn_42060 API",
    "DESCRIPTION": "API documentation for wdvn_42060 App",
    "VERSION": "v1",
}
